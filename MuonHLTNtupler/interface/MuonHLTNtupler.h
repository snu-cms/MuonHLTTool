...
private:
  ...
  double   hltIter0IterL3MuonPixelSeedsFromPixelTracks_tsos_pt_[arrSize_];
  int      hltIter0IterL3MuonPixelSeedsFromPixelTracks_tsos_hasErr_[arrSize_];
  double   hltIter0IterL3MuonPixelSeedsFromPixelTracks_tsos_err0_[arrSize_];
  double   hltIter0IterL3MuonPixelSeedsFromPixelTracks_tsos_err1_[arrSize_];
  double   hltIter0IterL3MuonPixelSeedsFromPixelTracks_tsos_err2_[arrSize_];
  double   hltIter0IterL3MuonPixelSeedsFromPixelTracks_tsos_err3_[arrSize_];
  double   hltIter0IterL3MuonPixelSeedsFromPixelTracks_tsos_err4_[arrSize_];
  double   hltIter0IterL3MuonPixelSeedsFromPixelTracks_tsos_err5_[arrSize_];
  double   hltIter0IterL3MuonPixelSeedsFromPixelTracks_tsos_err6_[arrSize_];
  double   hltIter0IterL3MuonPixelSeedsFromPixelTracks_tsos_err7_[arrSize_];
  double   hltIter0IterL3MuonPixelSeedsFromPixelTracks_tsos_err8_[arrSize_];
  double   hltIter0IterL3MuonPixelSeedsFromPixelTracks_tsos_err9_[arrSize_];
  double   hltIter0IterL3MuonPixelSeedsFromPixelTracks_tsos_err10_[arrSize_];
  double   hltIter0IterL3MuonPixelSeedsFromPixelTracks_tsos_err11_[arrSize_];
  double   hltIter0IterL3MuonPixelSeedsFromPixelTracks_tsos_err12_[arrSize_];
  double   hltIter0IterL3MuonPixelSeedsFromPixelTracks_tsos_err13_[arrSize_];
  double   hltIter0IterL3MuonPixelSeedsFromPixelTracks_tsos_err14_[arrSize_];
  double   hltIter0IterL3MuonPixelSeedsFromPixelTracks_tsos_x_[arrSize_];
  double   hltIter0IterL3MuonPixelSeedsFromPixelTracks_tsos_y_[arrSize_];
  double   hltIter0IterL3MuonPixelSeedsFromPixelTracks_tsos_dxdz_[arrSize_];
  double   hltIter0IterL3MuonPixelSeedsFromPixelTracks_tsos_dydz_[arrSize_];
  double   hltIter0IterL3MuonPixelSeedsFromPixelTracks_tsos_px_[arrSize_];
  double   hltIter0IterL3MuonPixelSeedsFromPixelTracks_tsos_py_[arrSize_];
  double   hltIter0IterL3MuonPixelSeedsFromPixelTracks_tsos_pz_[arrSize_];
  double   hltIter0IterL3MuonPixelSeedsFromPixelTracks_tsos_qbp_[arrSize_];
  ...
  double   hltIter2IterL3MuonPixelSeeds_tsos_pt_[arrSize_];
  int      hltIter2IterL3MuonPixelSeeds_tsos_hasErr_[arrSize_];
  double   hltIter2IterL3MuonPixelSeeds_tsos_err0_[arrSize_];
  double   hltIter2IterL3MuonPixelSeeds_tsos_err1_[arrSize_];
  double   hltIter2IterL3MuonPixelSeeds_tsos_err2_[arrSize_];
  double   hltIter2IterL3MuonPixelSeeds_tsos_err3_[arrSize_];
  double   hltIter2IterL3MuonPixelSeeds_tsos_err4_[arrSize_];
  double   hltIter2IterL3MuonPixelSeeds_tsos_err5_[arrSize_];
  double   hltIter2IterL3MuonPixelSeeds_tsos_err6_[arrSize_];
  double   hltIter2IterL3MuonPixelSeeds_tsos_err7_[arrSize_];
  double   hltIter2IterL3MuonPixelSeeds_tsos_err8_[arrSize_];
  double   hltIter2IterL3MuonPixelSeeds_tsos_err9_[arrSize_];
  double   hltIter2IterL3MuonPixelSeeds_tsos_err10_[arrSize_];
  double   hltIter2IterL3MuonPixelSeeds_tsos_err11_[arrSize_];
  double   hltIter2IterL3MuonPixelSeeds_tsos_err12_[arrSize_];
  double   hltIter2IterL3MuonPixelSeeds_tsos_err13_[arrSize_];
  double   hltIter2IterL3MuonPixelSeeds_tsos_err14_[arrSize_];
  double   hltIter2IterL3MuonPixelSeeds_tsos_x_[arrSize_];
  double   hltIter2IterL3MuonPixelSeeds_tsos_y_[arrSize_];
  double   hltIter2IterL3MuonPixelSeeds_tsos_dxdz_[arrSize_];
  double   hltIter2IterL3MuonPixelSeeds_tsos_dydz_[arrSize_];
  double   hltIter2IterL3MuonPixelSeeds_tsos_px_[arrSize_];
  double   hltIter2IterL3MuonPixelSeeds_tsos_py_[arrSize_];
  double   hltIter2IterL3MuonPixelSeeds_tsos_pz_[arrSize_];
  double   hltIter2IterL3MuonPixelSeeds_tsos_qbp_[arrSize_];
  ...
  double   hltIter3IterL3MuonPixelSeeds_tsos_pt_[arrSize_];
  int      hltIter3IterL3MuonPixelSeeds_tsos_hasErr_[arrSize_];
  double   hltIter3IterL3MuonPixelSeeds_tsos_err0_[arrSize_];
  double   hltIter3IterL3MuonPixelSeeds_tsos_err1_[arrSize_];
  double   hltIter3IterL3MuonPixelSeeds_tsos_err2_[arrSize_];
  double   hltIter3IterL3MuonPixelSeeds_tsos_err3_[arrSize_];
  double   hltIter3IterL3MuonPixelSeeds_tsos_err4_[arrSize_];
  double   hltIter3IterL3MuonPixelSeeds_tsos_err5_[arrSize_];
  double   hltIter3IterL3MuonPixelSeeds_tsos_err6_[arrSize_];
  double   hltIter3IterL3MuonPixelSeeds_tsos_err7_[arrSize_];
  double   hltIter3IterL3MuonPixelSeeds_tsos_err8_[arrSize_];
  double   hltIter3IterL3MuonPixelSeeds_tsos_err9_[arrSize_];
  double   hltIter3IterL3MuonPixelSeeds_tsos_err10_[arrSize_];
  double   hltIter3IterL3MuonPixelSeeds_tsos_err11_[arrSize_];
  double   hltIter3IterL3MuonPixelSeeds_tsos_err12_[arrSize_];
  double   hltIter3IterL3MuonPixelSeeds_tsos_err13_[arrSize_];
  double   hltIter3IterL3MuonPixelSeeds_tsos_err14_[arrSize_];
  double   hltIter3IterL3MuonPixelSeeds_tsos_x_[arrSize_];
  double   hltIter3IterL3MuonPixelSeeds_tsos_y_[arrSize_];
  double   hltIter3IterL3MuonPixelSeeds_tsos_dxdz_[arrSize_];
  double   hltIter3IterL3MuonPixelSeeds_tsos_dydz_[arrSize_];
  double   hltIter3IterL3MuonPixelSeeds_tsos_px_[arrSize_];
  double   hltIter3IterL3MuonPixelSeeds_tsos_py_[arrSize_];
  double   hltIter3IterL3MuonPixelSeeds_tsos_pz_[arrSize_];
  double   hltIter3IterL3MuonPixelSeeds_tsos_qbp_[arrSize_];
  ...
  double   hltIter0IterL3FromL1MuonPixelSeedsFromPixelTracks_tsos_pt_[arrSize_];
  int      hltIter0IterL3FromL1MuonPixelSeedsFromPixelTracks_tsos_hasErr_[arrSize_];
  double   hltIter0IterL3FromL1MuonPixelSeedsFromPixelTracks_tsos_err0_[arrSize_];
  double   hltIter0IterL3FromL1MuonPixelSeedsFromPixelTracks_tsos_err1_[arrSize_];
  double   hltIter0IterL3FromL1MuonPixelSeedsFromPixelTracks_tsos_err2_[arrSize_];
  double   hltIter0IterL3FromL1MuonPixelSeedsFromPixelTracks_tsos_err3_[arrSize_];
  double   hltIter0IterL3FromL1MuonPixelSeedsFromPixelTracks_tsos_err4_[arrSize_];
  double   hltIter0IterL3FromL1MuonPixelSeedsFromPixelTracks_tsos_err5_[arrSize_];
  double   hltIter0IterL3FromL1MuonPixelSeedsFromPixelTracks_tsos_err6_[arrSize_];
  double   hltIter0IterL3FromL1MuonPixelSeedsFromPixelTracks_tsos_err7_[arrSize_];
  double   hltIter0IterL3FromL1MuonPixelSeedsFromPixelTracks_tsos_err8_[arrSize_];
  double   hltIter0IterL3FromL1MuonPixelSeedsFromPixelTracks_tsos_err9_[arrSize_];
  double   hltIter0IterL3FromL1MuonPixelSeedsFromPixelTracks_tsos_err10_[arrSize_];
  double   hltIter0IterL3FromL1MuonPixelSeedsFromPixelTracks_tsos_err11_[arrSize_];
  double   hltIter0IterL3FromL1MuonPixelSeedsFromPixelTracks_tsos_err12_[arrSize_];
  double   hltIter0IterL3FromL1MuonPixelSeedsFromPixelTracks_tsos_err13_[arrSize_];
  double   hltIter0IterL3FromL1MuonPixelSeedsFromPixelTracks_tsos_err14_[arrSize_];
  double   hltIter0IterL3FromL1MuonPixelSeedsFromPixelTracks_tsos_x_[arrSize_];
  double   hltIter0IterL3FromL1MuonPixelSeedsFromPixelTracks_tsos_y_[arrSize_];
  double   hltIter0IterL3FromL1MuonPixelSeedsFromPixelTracks_tsos_dxdz_[arrSize_];
  double   hltIter0IterL3FromL1MuonPixelSeedsFromPixelTracks_tsos_dydz_[arrSize_];
  double   hltIter0IterL3FromL1MuonPixelSeedsFromPixelTracks_tsos_px_[arrSize_];
  double   hltIter0IterL3FromL1MuonPixelSeedsFromPixelTracks_tsos_py_[arrSize_];
  double   hltIter0IterL3FromL1MuonPixelSeedsFromPixelTracks_tsos_pz_[arrSize_];
  double   hltIter0IterL3FromL1MuonPixelSeedsFromPixelTracks_tsos_qbp_[arrSize_];
  ...
  double   hltIter2IterL3FromL1MuonPixelSeeds_tsos_pt_[arrSize_];
  int      hltIter2IterL3FromL1MuonPixelSeeds_tsos_hasErr_[arrSize_];
  double   hltIter2IterL3FromL1MuonPixelSeeds_tsos_err0_[arrSize_];
  double   hltIter2IterL3FromL1MuonPixelSeeds_tsos_err1_[arrSize_];
  double   hltIter2IterL3FromL1MuonPixelSeeds_tsos_err2_[arrSize_];
  double   hltIter2IterL3FromL1MuonPixelSeeds_tsos_err3_[arrSize_];
  double   hltIter2IterL3FromL1MuonPixelSeeds_tsos_err4_[arrSize_];
  double   hltIter2IterL3FromL1MuonPixelSeeds_tsos_err5_[arrSize_];
  double   hltIter2IterL3FromL1MuonPixelSeeds_tsos_err6_[arrSize_];
  double   hltIter2IterL3FromL1MuonPixelSeeds_tsos_err7_[arrSize_];
  double   hltIter2IterL3FromL1MuonPixelSeeds_tsos_err8_[arrSize_];
  double   hltIter2IterL3FromL1MuonPixelSeeds_tsos_err9_[arrSize_];
  double   hltIter2IterL3FromL1MuonPixelSeeds_tsos_err10_[arrSize_];
  double   hltIter2IterL3FromL1MuonPixelSeeds_tsos_err11_[arrSize_];
  double   hltIter2IterL3FromL1MuonPixelSeeds_tsos_err12_[arrSize_];
  double   hltIter2IterL3FromL1MuonPixelSeeds_tsos_err13_[arrSize_];
  double   hltIter2IterL3FromL1MuonPixelSeeds_tsos_err14_[arrSize_];
  double   hltIter2IterL3FromL1MuonPixelSeeds_tsos_x_[arrSize_];
  double   hltIter2IterL3FromL1MuonPixelSeeds_tsos_y_[arrSize_];
  double   hltIter2IterL3FromL1MuonPixelSeeds_tsos_dxdz_[arrSize_];
  double   hltIter2IterL3FromL1MuonPixelSeeds_tsos_dydz_[arrSize_];
  double   hltIter2IterL3FromL1MuonPixelSeeds_tsos_px_[arrSize_];
  double   hltIter2IterL3FromL1MuonPixelSeeds_tsos_py_[arrSize_];
  double   hltIter2IterL3FromL1MuonPixelSeeds_tsos_pz_[arrSize_];
  double   hltIter2IterL3FromL1MuonPixelSeeds_tsos_qbp_[arrSize_];
  ...
  double   hltIter3IterL3FromL1MuonPixelSeeds_tsos_pt_[arrSize_];
  int      hltIter3IterL3FromL1MuonPixelSeeds_tsos_hasErr_[arrSize_];
  double   hltIter3IterL3FromL1MuonPixelSeeds_tsos_err0_[arrSize_];
  double   hltIter3IterL3FromL1MuonPixelSeeds_tsos_err1_[arrSize_];
  double   hltIter3IterL3FromL1MuonPixelSeeds_tsos_err2_[arrSize_];
  double   hltIter3IterL3FromL1MuonPixelSeeds_tsos_err3_[arrSize_];
  double   hltIter3IterL3FromL1MuonPixelSeeds_tsos_err4_[arrSize_];
  double   hltIter3IterL3FromL1MuonPixelSeeds_tsos_err5_[arrSize_];
  double   hltIter3IterL3FromL1MuonPixelSeeds_tsos_err6_[arrSize_];
  double   hltIter3IterL3FromL1MuonPixelSeeds_tsos_err7_[arrSize_];
  double   hltIter3IterL3FromL1MuonPixelSeeds_tsos_err8_[arrSize_];
  double   hltIter3IterL3FromL1MuonPixelSeeds_tsos_err9_[arrSize_];
  double   hltIter3IterL3FromL1MuonPixelSeeds_tsos_err10_[arrSize_];
  double   hltIter3IterL3FromL1MuonPixelSeeds_tsos_err11_[arrSize_];
  double   hltIter3IterL3FromL1MuonPixelSeeds_tsos_err12_[arrSize_];
  double   hltIter3IterL3FromL1MuonPixelSeeds_tsos_err13_[arrSize_];
  double   hltIter3IterL3FromL1MuonPixelSeeds_tsos_err14_[arrSize_];
  double   hltIter3IterL3FromL1MuonPixelSeeds_tsos_x_[arrSize_];
  double   hltIter3IterL3FromL1MuonPixelSeeds_tsos_y_[arrSize_];
  double   hltIter3IterL3FromL1MuonPixelSeeds_tsos_dxdz_[arrSize_];
  double   hltIter3IterL3FromL1MuonPixelSeeds_tsos_dydz_[arrSize_];
  double   hltIter3IterL3FromL1MuonPixelSeeds_tsos_px_[arrSize_];
  double   hltIter3IterL3FromL1MuonPixelSeeds_tsos_py_[arrSize_];
  double   hltIter3IterL3FromL1MuonPixelSeeds_tsos_pz_[arrSize_];
  double   hltIter3IterL3FromL1MuonPixelSeeds_tsos_qbp_[arrSize_];
